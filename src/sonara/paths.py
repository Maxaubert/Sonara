...
SESSION_SEEN_PATH = SONARA_DIR / "session_seen.json"    # per-session last-activity epoch
SESSION_DIGESTS_PATH = SONARA_DIR / "session_digests.json"  # per-session last digest text (#118)
